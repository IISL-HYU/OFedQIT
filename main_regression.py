...
with open("./Regression_mse/OFedAvg_{data}_L{L}_p{prob}.pkl","wb") as f:
    pickle.dump(loss_list, f)
    
with open("./Regression_mse/OFedQIT_{data}_L{L1}_s1_b{b}_p{prob}.pkl","wb") as f:
    pickle.dump(q_loss_list, f)

with open("./Regression_mse/OFedQIT_{data}_L{L2}_s1_b{b}_p{prob}.pkl","wb") as f:
    pickle.dump(q2_loss_list, f)
    
with open("./Regression_mse/OFedAvg_{data}_L{L}_p{prob2}.pkl","wb") as f:
    pickle.dump(p2_loss_list, f)
    
with open("./Regression_mse/OFedQIT_{data}_L{L1}_s1_b{b}_p{prob2}.pkl","wb") as f:
    pickle.dump(q_p2_loss_list, f)

with open("./Regression_mse/OFedQIT_{data}_L{L2}_s1_b{b}_p{prob2}.pkl","wb") as f:
    pickle.dump(q2_p2_loss_list, f)
    
with open("./Regression_mse/OFedAvg_{data}_L{L}_p{prob3}.pkl","wb") as f:
    pickle.dump(p3_loss_list, f)
    
with open("./Regression_mse/OFedQIT_{data}_L{L1}_s1_b{b}_p{prob3}.pkl","wb") as f:
    pickle.dump(q_p3_loss_list, f)

with open("./Regression_mse/OFedQIT_{data}_L{L2}_s1_b{b}_p{prob3}.pkl","wb") as f:
